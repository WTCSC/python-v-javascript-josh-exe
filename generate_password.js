function generatePassword(length = 12) {  //----------------------------------------------------------  Creates a function that generates a password with a length of 12 characters
    ...
    password += characters.charAt(Math.floor(Math.random() * characters.length));  //-----------------  Generates a random character based on the length (a lenght of 12 will generate 12 random characters)
    }
